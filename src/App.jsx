...
// ─── STYLE ─────────────────────────────────────────────────────────────────
const GLOBAL_CSS = `
  @import url('https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=Space+Mono:wght@400;700&display=swap');
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .rc-sys-label { font-size: 9.5px; font-weight: 700; color: var(--ink-muted); letter-spacing: 0.05em; text-transform: uppercase; }
  .rc-title { font-size: 13px; font-weight: 600; color: var(--ink); margin-bottom: 4px; line-height: 1.3; }
  .rc-keywords { font-size: 10.5px; color: var(--ink-muted); overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
